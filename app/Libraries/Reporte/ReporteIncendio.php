...
class ReporteIncendio
{
    public function generar_reporte($desde, $hasta)
    {
        ...
        $emisiones = $libreria->emisiones("(Plan:equals:Seguro Incendio Hipotecario)");
        ...
        $sheet->setCellValue('P12', 'Desde');
        $sheet->setCellValue('Q12', 'Hasta');
        ...
        foreach ($emisiones as $emision) {
            if (
                ...
                $sheet->setCellValue('G' . $pos, $emision->getFieldValue("Nombre") . " ReporteIncendio.php" . $emision->getFieldValue("Apellido"));
                ...
                $sheet->setCellValue('P' . $pos, $emision->getFieldValue('Vigencia_desde'));
                $sheet->setCellValue('Q' . $pos, $emision->getFieldValue('Valid_Till'));
