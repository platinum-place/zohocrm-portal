...
class ReporteAuto
{
    public function generar_reporte($desde, $hasta)
    {
        ...
        $emisiones = $libreria->emisiones("(Plan:equals:Mensual Full) and (Plan:equals:Anual Full)");
        ...
        $sheet->setCellValue('S12', 'Desde');
        $sheet->setCellValue('T12', 'Hasta');
        ...
        foreach ($emisiones as $emision) {
            if (
                ...
                $sheet->setCellValue('S' . $pos, $emision->getFieldValue('Vigencia_desde'));
                $sheet->setCellValue('T' . $pos, $emision->getFieldValue('Valid_Till'));
