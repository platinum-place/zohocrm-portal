...
class ReporteDesempleo
{
    public function generar_reporte($desde, $hasta)
    {
        ...
        $emisiones = $libreria->emisiones("(Plan:equals:Vida/Desempleo)");
        ...
        foreach ($emisiones as $emision) {
            if (
                ...
                $sheet->setCellValue('G' . $pos, $emision->getFieldValue("Nombre") . " ReporteDesempleo.php" . $emision->getFieldValue("Apellido"));
